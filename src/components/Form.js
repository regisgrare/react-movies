...
const Form = () => {
    ...
    useEffect(() => {
        axios.get(`https://api.themoviedb.org/3/search/movie?api_key=fecd29f9a1448c7384d06cf4bffd1e9d&query=${search}&language=fr-FR`).then((res) => setMoviesData(res.data.results))
